...
const projects = [
  ...
  { title: "infradevops.xyz", status: "Live", statusTone: "live", description: "This portfolio. Built with a modern web stack and deployed on Cloudflare Pages. Proof that infrastructure engineers can ship calm frontend code too.", tags: ["React", "Cloudflare", "CI/CD"], href: "https://infradevops.xyz", metric: "02 / SHIP" },
